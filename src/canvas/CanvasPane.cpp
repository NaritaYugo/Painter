...
#include "app/NativeWindowLog.h" // 診断ログ(TIEPOLO_WINLOG)。ドラッグ開始の計測に使う
...
public:
    ...
    {
        setObjectName(QStringLiteral("canvasTabs"));
        setDocumentMode(true);
        setContentsMargins(0, 0, 0, 0);
        auto *bar = new CanvasTabBar(this);
        bar->setObjectName(QStringLiteral("canvasTabBar"));
        setTabBar(bar);
...
{
    setObjectName(QStringLiteral("canvasPane"));
